package github.fixinggithub.levelup.utility;
...
public class KeyBinding {
    ...
    public static final String KEY_VIT = "key.levelup.upgrade_vit";
    ...
    public static final KeyMapping UPGRADE_CON = new KeyMapping(KEY_CON, KeyConflictContext.IN_GAME,
            InputConstants.Type.KEYSYM, GLFW.GLFW_KEY_UNKNOWN, KEY_CATEGORY_LEVELUP);
